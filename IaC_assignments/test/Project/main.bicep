...
module VM  'modules/VM_networking.bicep' = {
  ...
  params: {
    ...
    linuxName:linuxName
    adminIP:adminIP
    adminPassword:adminPassword //kv.getSecret(adminPassword)
    adminUser:adminUser//kv.getSecret(adminUser)
    linuxPassword:linuxPassword//kv.getSecret(linuxPassword)
    linuxUser:linuxUser//kv.getSecret(linuxUser)
