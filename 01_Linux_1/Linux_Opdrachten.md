...
-h      Maakt de filesize output van -l "humanreabble".
-R      Recursive listing: dit laat de inhoud van onderliggende mappen zien. 
...
Voor deze worden de volgende deelopdrachten gevraagd:
